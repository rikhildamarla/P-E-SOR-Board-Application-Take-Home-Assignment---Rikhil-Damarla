...
public final class Constants {
    ...
    // GRAVITECHX SHOOTER CONTSANTS
    public static final class Shooter {
        // TODO: PLACEHOLDER PID
        public static final PidProfile PID_PROFILE = new PidProfile(0.01, 0, 0);
        public static final double FLYWHEEL_CURRENT_LIMIT = 30.0;
        public static final double FLYWHEEL_MAX_OUTPUT = 0.8;
        public static final double STORAGE_CURRENT_LIMIT = 30.0;
        public static final double STORAGE_MAX_OUTPUT = 0.8;
        public static final double FLYWHEEL_SPEAKER_SHOOT_RPM = 4000;
        public static final double FLYWHEEL_FUNNEL_SHOOT_RPM = 1300;
        public static final double FLYWHEEL_GENERAL_SHOOT_RPM = 1100;
        public static final int SPEAKER_VOLTAGE = 11;
        public static final int FUNNEL_VOLTAGE = 6;
        public static final int GENERAL_VOLTAGE = 4;
        public static final int AMP_VOLTAGE = 2;
        public static final int DEFAULT_VOLTAGE = 9;
        public static final double LIMELIGHT_MOUNT_ANGLE = 25.0;
        //the following is in inches(arbitrary)
        public static final double LIMELIGHT_HEIGHT = 24.0;
    ...
    public static final class Motor {
        ...
        public static final int RELAY = 13;
        public static final int STORAGE = 14;
        public static final int ROLLER_OUTTAKE_BOTTOM = 16;
        public static final int ROLLER_OUTTAKE_TOP = 17;

        public static final int ACTUAL_CLIMB_LEFT = 18;
        public static final int ACTUAL_CLIMB_RIGHT = 19;
    }
