...
public class FunnelShoot extends Command {
  @SuppressWarnings({"PMD.UnusedPrivateField", "PMD.SingularField"})
  private final Shooter Shooter;
  private final LinearFilter lf;
  
  public FunnelShoot(Shooter subsystem) {
    Shooter = subsystem;
  ...
  public void execute() {
    ...
    Shooter.setFlywheels("Funnel");
    if (value >= Constants.Shooter.FLYWHEEL_FUNNEL_SHOOT_RPM) { // TODO: Change Values to Constants
        Shooter.outtake();
    }
  }
