...
public class GeneralShoot extends Command {
  @SuppressWarnings({"PMD.UnusedPrivateField", "PMD.SingularField"})
  private final Shooter Shooter;
  private final LinearFilter lf;
  
  public GeneralShoot(Shooter subsystem) {
    Shooter = subsystem;
  ...
  public void execute() {
    ...
    Shooter.setFlywheels("General");
    if (value >= Constants.Shooter.FLYWHEEL_GENERAL_SHOOT_RPM) { // TODO: Change Values to Constants
        Shooter.outtake();
    }
  }
